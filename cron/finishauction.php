...
$message = '<img src="http://minecraftservers.com/images/logo.png"/><br/><br/>
...
<br/><br/> <a href="http://minecraftservers.com/bid?pay='.$b['id'].'">Click here to activate your banner.</a>';
$headers = 'From: noreply@minecraftserver.com'."\r\n";
